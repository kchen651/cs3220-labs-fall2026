...
The FP32 spec is as follows:

| Signal | I/O | Width | Functionality |
| :--- | :--- | :--- | :--- |
| i\_clk | Input | 1 | Clock signal |
| i\_rst\_n | Input | 1 | Active low asynchronous reset |
| i\_data\_a | Input | 32 | IEEE-754 single precision (1-8-23) operand a |
| i\_data\_b | Input | 32 | IEEE-754 single precision (1-8-23) operand b |
...
Format: **IEEE-754 single precision (1-8-23)**. Bit fields are `sign[31]`, `exponent[7:0]`, `fraction[22:0]` packed into a 32-bit word.
