...
The FP16 spec is as follows:

| Signal | I/O | Width | Functionality |
| :--- | :--- | :--- | :--- |
| i\_clk | Input | 1 | Clock signal |
| i\_rst\_n | Input | 1 | Active low asynchronous reset |
| i\_data\_a | Input | 16 | IEEE-754 half precision (1-5-10) operand a |
| i\_data\_b | Input | 16 | IEEE-754 half precision (1-5-10) operand b |
...
Format: **IEEE-754 half precision (1-5-10)**. Bit fields are `sign[15]`, `exponent[4:0]`, `fraction[9:0]` packed into a 16-bit word.
